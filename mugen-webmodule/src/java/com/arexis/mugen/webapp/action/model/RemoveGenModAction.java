 ...
 * @author lami
 */
public class RemoveGenModAction extends MugenAction {
    
    /** Creates a new instance of RemoveGenModAction */
    public RemoveGenModAction() {
    }
    ...
    public boolean performAction(HttpServletRequest request, ServletContext context) throws ApplicationException {
        try {
            ...
            modelManager.removeGeneticModification(Integer.parseInt(gmid), caller);
