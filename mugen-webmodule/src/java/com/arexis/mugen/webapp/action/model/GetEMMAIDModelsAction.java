...
public class GetEMMAIDModelsAction extends MugenAction {
    
    private static Logger logger = Logger.getLogger(GetModelsAction.class);
    
    public GetEMMAIDModelsAction() {
    }
    ...
    public boolean performAction(HttpServletRequest req, ServletContext context) throws ApplicationException {
        try {
            ...
            req.setAttribute("modelsdto", modelManager.getExperimentalModelsWithEMMAID(caller.getSuid(), caller));
            ...
            //e.printStackTrace();
            logger.error("GetEMMAIDModelsAction Action failed", e);
