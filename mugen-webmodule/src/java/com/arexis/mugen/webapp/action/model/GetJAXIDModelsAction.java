...
public class GetJAXIDModelsAction extends MugenAction {
    
    private static Logger logger = Logger.getLogger(GetModelsAction.class);
    
    public GetJAXIDModelsAction() {}

    public String getName() {
        return "GetJAXIDModelsAction";
    }
    ...
    public boolean performAction(HttpServletRequest req, ServletContext context) throws ApplicationException {
        try {
            ...
            req.setAttribute("modelsdto", modelManager.getExperimentalModelsWithJAXID(caller.getSuid(), caller));
            ...
            //e.printStackTrace();
            logger.error("GetJAXIDModelsAction Action failed", e);
