...
<html>
    ...
    <table class="block">
        <th class="block"><a href="Help?help.viewstrain_display=true" title="Expand/Collapse this section">View MUGEN Mutant Mouse Details</a></th>
        <tr><td></td></tr>
    ...
    <%--view gene details--%>
    <table class="block">
        <th class="block"><a href="Help?help.viewgene_display=true" title="Expand/Collapse this section">View Gene Details</a></th>
        <tr><td></td></tr>
    ...
    <table class="block">
        <th class="block"><a href="Help?help.createstrain_display=true" title="Expand/Collapse this section">Create a MUGEN Mutant Mouse</a></th>
        <tr><td></td></tr>
    ...
    <table class="block">
        <th class="block"><a href="Help?help.creategene_display=true" title="Expand/Collapse this section">Create a Gene</a></th>
        <tr><td></td></tr>
    ...
    <table class="block">
        <th class="block"><a href="Help?help.search_display=true" title="Expand/Collapse this section">Search the MUGEN database</a></th>
        <tr><td></td></tr>
