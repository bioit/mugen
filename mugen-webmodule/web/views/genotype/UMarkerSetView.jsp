...
<html>
    <head>
        ...
        <title>View Unified Marker set</title>
    </head>
    <body>
        <h1>View Unified Marker set</h1>
        <form action="Controller" method="post">
            <input id="button" type="hidden" name="umsid" value='<jsp:getProperty name="umarkerset" property="umsid"/>'/>
            <p>
                ...
                <table class="data">  
                    ...
                    <tr>
                        <td><jsp:getProperty name="umarkerset" property="name"/></td>      
                        <td><jsp:getProperty name="umarkerset" property="comm"/></td>
                        <td><jsp:getProperty name="umarkerset" property="user"/></td>          
                        <td><jsp:getProperty name="umarkerset" property="updated"/></td>                         
                    <tr>
                    <tr>
